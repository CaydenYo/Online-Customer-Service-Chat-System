<template>
    <div style="width:100%;height:100%">
        <section class="chatlist" :class="showSelBox>0?'chatlist-bottom-collapse':'chatlist-bottom'" style="float:left">
