...
public class CustomerRegisterBean {
	...
	public CustomerRegisterBean(String customer_name, int customer_sex, String customer_email, String customer_pwd,
	...
	public String toString() {
		return "CustomerRegisterBean [customer_name=" + customer_name + ", customer_sex=" + customer_sex
				+ ", customer_email=" + customer_email + ", customer_pwd=" + customer_pwd + ", customer_address="
				+ customer_address + "]";
	}
